...
from .domain import (
    Config, Session, Manifest, ManifestCamera, ManifestTTL,
    CameraVerificationResult, VerificationSummary, VerificationResult
)
...
def build_manifest(config: Config, session: Session) -> Manifest:
    ...
    for ttl_config in session.TTLs:
        ...
        ttls.append(ManifestTTL(
            ttl_id=ttl_config.id,
            files=ttl_files
        ))
...
def verify_manifest(
    ...
    for camera in manifest.cameras:
        ...
        camera_results.append(CameraVerificationResult(
