...
class SessionFlowConfig(BaseModel):
    ...
    Attributes:
        config_path: Path to configuration TOML file (absolute path in container)
    ...
    config_path: str = Field(
        ...,
        description="Path to configuration TOML file (e.g., /configs/standard.toml)",
        examples=["/configs/standard.toml", "/configs/container.toml"],
    )
