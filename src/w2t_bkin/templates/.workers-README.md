...
This directory contains configuration for Prefect Docker workers.

## Files

- **`.env`** - Docker image and path configuration for workers
- **`README.md`** - This file
...
| Host Path (project root)            | Container Path                | Mode |
| ----------------------------------- | ----------------------------- | ---- |
...
"volumes": [
  ...
  "/path/to/experiment/output:/output:rw"
]
```
