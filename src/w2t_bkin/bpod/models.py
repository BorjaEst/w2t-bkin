"""Bpod MATLAB file parsing models.

This module defines Pydantic models for parsing Bpod .mat files.

These models represent the raw Bpod data structure loaded from .mat files
and are used by `w2t_bkin.bpod.code` for parsing and validation.

For behavioral data extraction and NWB conversion, use the behavior module
with ndx-structured-behavior classes instead of these raw parsing models.
"""
