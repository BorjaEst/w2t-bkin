"""
Unit tests for ecephys device module.

Tests Device creation and electrodes table population.
"""
...
from w2t_bkin.ingest.ecephys.device import add_electrodes_from_meta, create_neuropixels_device
