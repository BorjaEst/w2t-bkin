...
class TestCreateEventsTableFromTTLs:
    ...
    def test_uses_custom_sources(self):
        ...
        table = create_events_table_from_ttls(ttl_pulses, sources=sources)
    ...
    def test_custom_table_name(self):
        ...
        table = create_events_table_from_ttls(ttl_pulses, name="CustomTTLs")
...
class TestAddEventsToNWB:
    ...
    def test_adds_events_table_to_nwbfile(self, minimal_nwbfile):
        ...
        nwbfile = add_events_to_nwb(minimal_nwbfile, ttl_pulses)
    ...
    def test_returns_modified_nwbfile(self, minimal_nwbfile):
        ...
        result = add_events_to_nwb(minimal_nwbfile, ttl_pulses)
